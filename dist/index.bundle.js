...
async function formatWeather(weather) {
  try {
    ...
    const newDate = (0,date_fns_tz__WEBPACK_IMPORTED_MODULE_1__.formatInTimeZone)(
      date,
...
/* harmony export */   "convertTimezoneToString": () => (/* binding */ convertTimezoneToString)
/* harmony export */ });
function convertTimezoneToString(timezone) {
  if (timezone === -12) {
  }
